...
public class EmployeeDetail extends JFrame {
   ...
   private void initComponents() {
      ...
      // Attendance Button
jButton6 = new JButton();
jButton6.setFont(new Font("Times New Roman", Font.BOLD, 24));
jButton6.setText("Employee Attendance");
jButton6.addMouseMotionListener(new MouseMotionAdapter() {
   public void mouseMoved(MouseEvent evt) {
...
jButton6.setBounds(480, 185, 260, 37);  
   ...
   new AttendanceMainUI().setVisible(true);
}
